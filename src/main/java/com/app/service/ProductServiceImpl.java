...
public class ProductServiceImpl implements IProductService {
	...
	@Override
	public Product saveProductWithImage(Product product, MultipartFile productImage,long categoryId ,long userId) {
		...
		User user = userRepo.findById(userId)
				.orElseThrow(()-> new ResourceNotFoundException("Seller Id "+userId+"Not Exist"));
		
		Seller seller = sellerRepo.findByName(user.getName())
				.orElseThrow(()-> new ResourceNotFoundException("Seller Name "+user.getName()+"Not Exist"));
